class AppStrings {
  ...
  static const String txtLogin = "Login";  // txtForgetPassword
  static const String txtForgetPassword = "Forget Password";
  static const String txtMobile = "Mobile Number";
  static const String txtPassword = "Password";
  static const String txtHrms = "HRMS";
  static const String txtHrmsTitle = "Human Resource Management System";
  // Enter mobile number  Enter 10 digit mobile number
  static const String txtMobileValidation = "Enter mobile number";
  static const String txtMobileValidation_2 = "Enter 10 digit mobile number";
  static const String txtPasswordValidation = "Enter password";
  static const String txtPasswordValidation_2 = "Please enter Valid Password";
  static const String txtStayConnected = "Stay Connected";
  static const String txtForgotPassword = "Forgot Password ?";// Powered By
  static const String txtPowerdBy = "Powered By";
